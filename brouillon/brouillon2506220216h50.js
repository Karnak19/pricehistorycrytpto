...
async function loopApiCall() {
 ...
 console.log('130', listCoinsID)

 // const addAmouts = () => {
 // listCoinsID.map((item, index) => {
 //   // item["t","value"] = prices[index].amount
 //   // console.log('item :', item.performance);
 //   prices.map((item, index) => {
 //     // item["t","value"] = prices[index].amount
 //     item.performance = item;
 //     // console.log('item :', item.performance);
 //     // return listCoinsID.push({ performance: item })
 //   }
 //     // return listCoinsID.push({ performance: item })
 //   )
 // }
 // )
 // console.log('134', listCoinsID);
 ...
 const findCoinsWithoutAllPastPerformance = listCoinsID.map((oneCoinPastperformance) => {
  ...
  // if (oneCoinPastperformance[0].timestamp != (`${fromThisTimeStamp}000`)) {
